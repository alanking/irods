...
TEST_CASE("basic write lock")
{
    ...
    SECTION("attempt open")
    {
        ...
        REQUIRE(GOOD_REPLICA == ir::replica_status(comm, target_object, 1));
        ...
        REQUIRE(INTERMEDIATE_REPLICA == ir::replica_status(comm, target_object, 0));
        REQUIRE(WRITE_LOCKED == ir::replica_status(comm, target_object, 1));
        ...
        CHECK(GOOD_REPLICA == ir::replica_status(comm, target_object, 0));
    ...
    {
        {
            ...
            CHECK(INTERMEDIATE_REPLICA == ir::replica_status(comm, target_object, 0));
            CHECK(WRITE_LOCKED == ir::replica_status(comm, target_object, 1));
