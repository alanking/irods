...
namespace irods::experimental::data_object
{
    ...
    public:
        ...
        ///
        /// \since 4.3.2
        auto find_replica(const std::string_view _hierarchy) -> std::optional<replica::replica_proxy<doi_type>>
        {
        ...
        ///
        /// \since 4.3.2
        auto find_replica(const std::string_view _hierarchy) const
    ...
    ///
    /// \since 4.3.2
    static auto find_replica(DataObjInfo& _info, const std::string_view _hierarchy) -> DataObjInfo*
    {
        namespace ir = irods::experimental::replica;
    ...
    ///
    /// \since 4.3.2
    static auto find_replica(const DataObjInfo& _info, const std::string_view _hierarchy) -> const DataObjInfo*
    {
        namespace ir = irods::experimental::replica;
