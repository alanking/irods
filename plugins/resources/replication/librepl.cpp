...
irods::error get_selected_hierarchy(
    ...
    if (!resc_hier_in_keyword) {
        ...
        if (cond_input.contains("selected_hierarchy")) {
            const auto hier_str = cond_input.at("selected_hierarchy").value();
            irods::log(LOG_NOTICE, fmt::format("[{}:{}] - selected_hierarchy:[{}]", __FUNCTION__, __LINE__, hier_str));
            if (hier_str.empty()) {
    ...
    if (!resc_hier_in_keyword) {
        ...
        irods::log(LOG_NOTICE, fmt::format("[{}:{}] - selected_hierarchy:[{}]", __FUNCTION__, __LINE__, selected_hier));
