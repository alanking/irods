...
if __name__ == '__main__':
    ...
    parser.add_argument('--topology_test', type='choice', choices=['icat', 'resource'], metavar='<icat|resource>')
    ...
    parser.add_argument('--federation', type='str', nargs=3, metavar='<remote irods version, remote zone, remote host>')
    parser.add_argument('--hostnames', type='str', nargs=4, metavar='<ICAT_HOSTNAME HOSTNAME_1 HOSTNAME_2 HOSTNAME_3>')
