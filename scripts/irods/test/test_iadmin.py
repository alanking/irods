...
class test_moduser_user(unittest.TestCase):
    ...
    def test_moduser_zone(self):
        ...
        remote_username = 'moduser_user_remote'
        user_and_zone = '#'.join([remote_username, remote_zone])
        ...
        try:
            ...
            self.assertEqual(remote_zone, lib.get_user_zone(self.admin, remote_username))
    ...
    def test_moduser_password(self):
        ...
        with self.assertRaises(Exception):
            with make_session_for_existing_user(self.username, pw1, host, self.admin.zone_name) as s:
                pass

        # Add password
        self.admin.assert_icommand(['iadmin', 'moduser', self.username, 'password', pw1])
        with session.make_session_for_existing_user(self.username, pw1, host, self.admin.zone_name) as s:
            pass

        # Change password
        pw2 = '1234'
        self.admin.assert_icommand(['iadmin', 'moduser', self.username, 'password', pw2])
        with session.make_session_for_existing_user(self.username, pw2, host, self.admin.zone_name) as s:
            pass
...
class test_moduser_group(unittest.TestCase):
    ...
    def test_moduser_password(self):
        ...
        pw = 'abc'
        with self.assertRaises(Exception):
            with make_session_for_existing_user(self.username, pw, host, self.admin.zone_name) as s:
                pass
