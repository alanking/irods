...
namespace
{
    int connect_to_remote_zone(rsComm_t *rsComm, dataObjCopyInp_t *dataObjCopyInp, rodsServerHost_t **rodsServerHost)
    {
    ...
    void close_source_data_obj(rsComm_t *rsComm, const int _inx)
    {
    ...
    void close_destination_data_obj(rsComm_t *rsComm, const int _inx, transferStat_t **transStat)
    {
        openedDataObjInp_t dataObjCloseInp{};
        dataObjCloseInp.l1descInx = _inx;
    ...
    int rsDataObjCopy_impl(rsComm_t *rsComm, dataObjCopyInp_t *dataObjCopyInp, transferStat_t **transStat)
    {
