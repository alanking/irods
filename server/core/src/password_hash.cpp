...
namespace irods
{
    ...
    auto hash_password(const std::string& _password, const std::string& _salt) -> std::string
    {
        ...
        log_server::trace("constructing parameters");
        OSSL_PARAM params[6];
        OSSL_PARAM* p = params;
        ...
        *p++ = OSSL_PARAM_construct_uint32(OSSL_KDF_PARAM_SCRYPT_P, &parallelization);
        // TODO: Maybe configure OSSL_KDF_PARAM_SCRYPT_MAXMEM here? Could affect calculation times.
        *p = OSSL_PARAM_construct_end();
        constexpr int key_len = 64;
        unsigned char hash_buf[key_len]{};
        log_server::trace("deriving key");
        ...
        log_server::trace("encoding hash");
        ...
        log_server::trace("Returning encoded hash");
